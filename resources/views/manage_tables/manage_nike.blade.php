                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody id="table-darkk">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="stails">
                                                <a href="{{ url('manage_tables/edit/edit/'.$item2->id.'/nike') }}" style="width:100px; padding-left:20px; padding-right:20px;" class="btn btnneed btn-primary btn-sm">Edit size</a>
