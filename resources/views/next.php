...
<body id="gradient-custom" class="no-chat-button gl-modal-open" style="overflow-y: scroll;" data-padding-right="85" img="https://jooinn.com/images/cloth-background-5.png">
...
<div class=lielss>
    <div class="liels1">
                    ...
                    <div class="lala">
                        <img href="#collapse" class="nav-toggle" src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcQnv9ij36ZmZzFbQ3agBIbpsB-sXXJkqqTEGMP3KKyqgNEfgLKS"/>
                    </div>
...
window.onload=function(){
    ...
    var shoeSizeMap = [
    { cm: '24,5', euroSize: '38,5' },
    { cm: '25', euroSize: '39' },
    { cm: '25,5', euroSize: '40' },
    { cm: '26', euroSize: '40,5' },
    { cm: '26,5', euroSize: '41' },
    { cm: '27', euroSize: '42' },
    { cm: '27,5', euroSize: '42,5' },
    { cm: '28', euroSize: '43' },
    { cm: '28,5', euroSize: '44' },
    { cm: '29', euroSize: '44,5' },
    { cm: '29,5', euroSize: '45' },
...
function Clean(){
  document.getElementById('log').innerHTML='';
    ...
    <div class="liels2">
                        <script type="text/javascript" src="http://code.jquery.com/jquery-1.7.2.js"></script>
                        <div class="lala1">
                            <img href="#collapse2" class="nav-toggle2" src="https://seeklogo.com/images/A/adidas-logo-49D5BEBA90-seeklogo.com.png"/>
                        </div>
...
function Clean(){
  document.getElementById('log').innerHTML='';
    ...
    <div class="liels3">
                <script type="text/javascript" src="http://code.jquery.com/jquery-1.7.2.js"></script>
                <div class="lala2">
                    <img href="#collapse3" class="nav-toggle3" src="https://th.bing.com/th/id/OIP.-5BzDHfG77aUDltzc_LIKQAAAA?pid=ImgDet&rs=1"/>
                </div>
...
background: linear-gradient(to right,#000000,#00A2FF,#000000)
}
